            ...
            {!loadingAppData && statusPage=='page' &&(
                ...
                <aside ref={asideMenuC}  className='asideMenuApp'>
                    <div className={`menusHolder ${visibleMenu? 'activeMenusHolder':''}`}>
                        <ServiceSgaCard imgRef={'https://cdnmain.sga360.co/static/ChatGPT_Image_7_sept_2025_13_29_09_v2xl9a.webp'} visbleInfo={visibleMenu} title={'Procesos'} desc={'SGA - Desarrollos'} />
