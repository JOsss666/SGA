...
export function RowTableReport({columns,info,type,hidden}){
    ...
    const dictionaryElementsColum = {
        ...
        'Descripción':<span title={info.description}>{info.description}</span>,
        ...
        'Concepto':<span title={info.type =='payment'? 'Pago '+info.payment_name:info.concept_name} onClick={()=>{console.log(info)}}>{info.type =='payment'? 'Pago '+info.payment_name:info.concept_name}</span>,
