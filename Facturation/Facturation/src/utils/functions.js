...
// Diccionario de nombres legibles (ES) por tipo de documento. Centralizado aquí para
// no duplicarlo en cada vista. Para documentos parametrizados (JSON Parametrization)
// el nombre real es el de la plantilla, así que se prefiere el `name` del documento.
