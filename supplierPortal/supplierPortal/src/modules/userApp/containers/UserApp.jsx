            ...
            {!loadingAppData && statusPage=='page' &&(
                ...
                <aside ref={asideMenuC}  className='asideMenuApp'>
                    <div className={`menusHolder ${visibleMenu? 'activeMenusHolder':'hiddenAsideMenu'}`}>
                        ...
                        <ServiceSgaCard imgRef={'https://cdnmain.sga360.co/static/Gemini_Generated_Image_fx4nzmfx4nzmfx4n-2_fizk0g.webp'} visbleInfo={visibleMenu} title={'Portal Proveedores'} desc={'SGA360 - Desarrollos'} />
