...
export function AppInfoProvider({children}){
    ...
    const optionsMenu = [
        ...
        {text:'Mi empresa',path:'myBussines',icon:<img src='https://cdnmain.sga360.co/static/ChatGPT_Image_26_oct_2025_16_03_39_d7hmbb.webp'/>,action:handleNavigate},
        {text:'Panel de control',path:'controlPanel',icon:<img src='https://cdnmain.sga360.co/static/InformesLogo1_iisxav.webp'/>,action:handleNavigate},
        {text:'Modulos',path:'modules',icon:<img src='https://cdnmain.sga360.co/static/CarpetaLogo1_zzjnut.webp'/>,action:handleNavigate},
        {text:'Servicios',path:'services',icon:<img src='https://cdnmain.sga360.co/static/ChatGPT_Image_6_dic_2025_13_01_36_1_adicoi.webp'/>,action:handleNavigate},
        {text:'Facturación',path:'billing',icon:<img src='https://cdnmain.sga360.co/static/ChatGPT_Image_7_sept_2025_16_22_25_vtvxph.webp'/>,action:handleNavigate},
        ...
        {text:'Usuarios',path:'users',icon:<img src='https://cdnmain.sga360.co/static/CuentaLogo1_aqqot5.webp'/>,action:handleNavigate},
        ...
        {text:'PLan de Cuentas',path:'accounts',icon:<img src='https://cdnmain.sga360.co/static/3d-business-wallet-finance-illustration-free-png_vr9tvx.webp'/>,action:handleNavigate},
    ]
