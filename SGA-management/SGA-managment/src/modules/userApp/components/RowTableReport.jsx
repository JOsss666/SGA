...
export function RowTableReport({columns,info,type,hidden}){
    ...
    const dictionaryElementsColum = {
        ...
        'Negocio':<span>{info.bussines_name != undefined? info.bussines_name:'null'}</span>,
        'Centro de costo':<span>{info.costcenter_name != undefined? info.costcenter_name:'null'}</span>,
        'Tercero':<span><UserCard name={info.thirdparty_name} imgSrc={info.thirdparty_img != undefined? info.thirdparty_img:'https://i.pinimg.com/736x/35/47/0c/35470c8c3ea8905f83e5efd5ccb3299b.jpg'}/></span>,
        ...
        'Saldo':<span>{info.final_balance != undefined? moneyFormat(info.final_balance):0}</span>,
