...
export function RowTableReport({columns,info,type,hidden}){
    ...
    const dictionaryElementsColum = {
        ...
        "Movmiento Inventario":<span className="Redirect idHolder rowSpan"># {info.movement_id}</span>,
        "Tipo movimiento":<span className="Redirect idHolder rowSpan" title={info.movement_type}>{info.movement_type}</span>,
        ...
        "Unidades":<span className="rowSpan rightAl">{info.units}</span>,
        "Cuenta":<span className="rowSpan">{info.account_code}</span>,
        'Estado':<span className="rowSpan">{info.status}</span>,
        ...
        'Sub Total':<span className="rowSpan">{`$ ${moneyFormat(parseFloat(info.subTotal))}`}</span>,
        'Base':<span className="rowSpan">{`$ ${moneyFormat(parseFloat(info.subTotal))}`}</span>,
        'Valor ':<span className="rowSpan ">{`$ ${moneyFormat(parseFloat(info.total))}`}</span>,
        ...
        'Naturaleza':<span className="rowSpan">{info.nature}</span>,
