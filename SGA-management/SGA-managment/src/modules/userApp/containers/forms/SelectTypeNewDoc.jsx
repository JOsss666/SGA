...
export function SelectTpeNewDoc({info,reloadFun}){
    ...
    const documents = [
        ...
        {title:'Entrada de mercancia',img:'https://res.cloudinary.com/djjxugmni/image/upload/v1766075163/Cuadricula2Documentos_6_pqxoh2.png',alert:<FormNewMovement/>},
        {title:'Salida de inventario',img:'https://res.cloudinary.com/djjxugmni/image/upload/v1766075210/Cuadricula2Documentos_8_ueftuc.png',alert:<FormNewMovement/>},
