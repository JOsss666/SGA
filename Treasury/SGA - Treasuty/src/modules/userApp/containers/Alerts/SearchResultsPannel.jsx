...
export function SearchResultsPannel({searchValue}){
    ...
    // El contexto es la fuente única de las secciones disponibles en Tesorería.
    // Las rutas dinámicas requieren un identificador real y se muestran mediante
    // los resultados de entidades que devuelve el backend.
    const navigationCatalog = (routesApp ?? [])
