...
export function ServicesGrid(){
    ...
    let services = [
        ...(userConfig.access.modules.management.use == true ? [{
            ...
            path:`https://www.management.sga360.co/SGA_management/${params.company_key}/${params.user_key}/`
        }] : []),
        ...(userConfig.access.modules.inventory.use == true ? [{
            ...
            path:`https://www.inventory.sga360.co/SGA_INVENTORY/${params.company_key}/${params.user_key}/`
        }] : []),
