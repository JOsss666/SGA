...
export function FormNewPriceList({ reloadInfo, update = false, updateInfo = {} }) {
    ...
    // Si no vas a usar la actualización por ahora, puedes eliminar esta función
    ...
    e.preventDefault();
    // Si ya se envió una vez, salimos de la función
    if (hasSubmitted.current) return;
    // Marcamos que se está enviando
    hasSubmitted.current = true;
    // Ejecutamos la función de creación
    createPriceList();
};

    // Precargar datos en modo edición (si se usa)
    useEffect(() => {
