...
// DATOS DE PRUEBA
const mockSeries = [
    { name: "", data: [0, 1, 2, 3, 0, 4, 2, 2, 3, 0, 4, 2, 0, 1, 2, 3, 0, 4, 2, 2, 3, 0, 4, 2, 0, 1, 2, 3, 0, 4, 2, 2, 3, 0, 4, 2, 0, 1, 2, 3, 0, 4, 2, 2, 3, 0, 4, 2,] },
    { name: "", data: [1, 0, 0, 2, 3, 1, 0, 0, 2, 3, 1, 0, 1, 0, 0, 2, 3, 1, 0, 0, 2, 3, 1, 0, 1, 0, 0, 2, 3, 1, 0, 0, 2, 3, 1, 0, 1, 0, 0, 2, 3, 1, 0, 0, 2, 3, 1, 0,] },
    { name: "", data: [0, 2, 4, 1, 0, 3, 2, 4, 1, 0, 3, 2, 0, 2, 4, 1, 0, 3, 2, 4, 1, 0, 3, 2, 0, 2, 4, 1, 0, 3, 2, 4, 1, 0, 3, 2, 0, 2, 4, 1, 0, 3, 2, 4, 1, 0, 3, 2,] },
    { name: "", data: [3, 1, 0, 0, 2, 4, 1, 0, 0, 2, 4, 1, 3, 1, 0, 0, 2, 4, 1, 0, 0, 2, 4, 1, 3, 1, 0, 0, 2, 4, 1, 0, 0, 2, 4, 1, 3, 1, 0, 0, 2, 4, 1, 0, 0, 2, 4, 1,] },
    { name: "", data: [2, 3, 1, 0, 0, 2, 4, 1, 0, 0, 2, 4, 2, 3, 1, 0, 0, 2, 4, 1, 0, 0, 2, 4, 2, 3, 1, 0, 0, 2, 4, 1, 0, 0, 2, 4, 2, 3, 1, 0, 0, 2, 4, 1, 0, 0, 2, 4,] },
    { name: "", data: [0, 1, 0, 2, 3, 1, 0, 0, 2, 3, 1, 0, 0, 1, 0, 2, 3, 1, 0, 0, 2, 3, 1, 0, 0, 1, 0, 2, 3, 1, 0, 0, 2, 3, 1, 0, 0, 1, 0, 2, 3, 1, 0, 0, 2, 3, 1, 0,] },
    { name: "", data: [1, 0, 2, 3, 1, 0, 2, 2, 3, 1, 0, 2, 1, 0, 2, 3, 1, 0, 2, 2, 3, 1, 0, 2, 1, 0, 2, 3, 1, 0, 2, 2, 3, 1, 0, 2, 1, 0, 2, 3, 1, 0, 2, 2, 3, 1, 0, 2,] }
    ];
