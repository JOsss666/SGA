        ...
        <div className={`RowTransaction ${info != undefined? `RowTrans_${info.stateTransaction}`:""}`}>
            ...
            {info != undefined && (
                <>
                    ...
                    {type != "entry" && (
                        <>
                            <span>$ {info.type == "consumo"? moneyFormat(info.unit_cost):moneyFormat(info.unit_value)}</span>
                            <span>$ {info.type == "consumo"? moneyFormat(movementsUnits * info.unit_cost):moneyFormat(movementsUnits * info.unit_value)}</span>
                        </>
                    )}
                    {type == "entry" && (
                        <>
