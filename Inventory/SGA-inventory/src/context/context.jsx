...
export function AppInfoProvider({children}){
    ...
    const optionsMenu = [
        ...
        ...(userConfig.access != undefined && userConfig.access.sections.search.overAll ? [{text:'Busqueda',path:'Search',icon:<img src='https://cdnmain.sga360.co/static/BuscarLogo1_jf8ij8.webp'/>,action:handleNavigate}]:[]),
        ...(userConfig.access != undefined && userConfig.access.sections.stores.overAll ? [{text:'Tienda',path:'Stores',icon:<img src='https://cdnmain.sga360.co/static/ChatGPT_Image_29_nov_2025_12_15_47_kxqs81.webp'/>,action:handleNavigate}]:[]),
        ...(userConfig.access != undefined && userConfig.access.sections.products.overAll ? [{text:'Productos',path:'Products',icon:<img src='https://cdnmain.sga360.co/static/ChatGPT_Image_1_dic_2025_15_04_38_3_hcdqxl.webp'/>,action:handleNavigate}]:[]),
        ...(userConfig.access != undefined && userConfig.access.sections.categories.overAll ? [{text:'Categorías',path:'Categories',icon:<img src='https://cdnmain.sga360.co/static/ChatGPT_Image_1_dic_2025_15_04_38_2_hwmmk5.webp'/>,action:handleNavigate},]:[]),
        ...
        ...(userConfig.access != undefined && userConfig.access.sections.pricesList.overAll ? [{text:'Listas de precios',path:'PricesList',icon:<img src='https://cdnmain.sga360.co/static/ChatGPT_Image_28_nov_2025_15_54_16_tl5bv3.webp'/>,action:handleNavigate},]:[]),
        ...(userConfig.access != undefined && userConfig.access.sections.movements.overAll ? [{text:'Movimientos',path:'Movements',icon:<img src='https://cdnmain.sga360.co/static/DocumentosLogo_fuofdc.webp'/>,action:handleNavigate},]:[]),
        ...(userConfig.access != undefined && userConfig.access.sections.reports.overAll ? [{text:'Informes',path:'reports',icon:<img src='https://cdnmain.sga360.co/static/InformesLogo1_iisxav.webp'/>,action:handleNavigate}]:[]),
        ...(userConfig.access != undefined && userConfig.access.sections.analytics.overAll ? [{text:'Estadisticas',path:'analytics',icon:<img src='https://cdnmain.sga360.co/static/ChatGPT_Image_27_oct_2025_10_28_59_2_u5cama.webp'/>,action:handleNavigate}]:[]),
    ...
    const routesApp = [
        ...
        {text:'Mensajes',path:'messages',icon:<img src='https://cdnmain.sga360.co/static/MensajesLogo2_y4fjoa.webp'/>,action:handleNavigate},
        ...(userConfig.access != undefined && userConfig.access.sections.users.overAll ? [{text:'Usuarios',path:'users',icon:<img src='https://cdnmain.sga360.co/static/CuentaLogo1_aqqot5.webp'/>,action:handleNavigate}]:[]),
        ...(userConfig.access != undefined && userConfig.access.sections.users.overAll ? [{text:'Terceros',path:'users',icon:<img src='https://cdnmain.sga360.co/static/ChatGPT_Image_27_oct_2025_10_28_59_3_juwusq.webp'/>,action:handleNavigate}]:[]),
        ...(userConfig.access != undefined && userConfig.access.sections.reports.overAll ? [{text:'Informes',path:'reports',icon:<img src='https://cdnmain.sga360.co/static/InformesLogo1_iisxav.webp'/>,action:handleNavigate}]:[]),
        ...
        ...(userConfig.access != undefined && userConfig.access.sections.analytics.overAll ? [{text:'Estadisticas',path:'analytics',icon:<img src='https://cdnmain.sga360.co/static/ChatGPT_Image_27_oct_2025_10_28_59_2_u5cama.webp'/>,action:handleNavigate}]:[]),
            {text:'Estadisticas Ordenes de Cliente (OCS)',path:'analytics/OCS',icon:<img src='https://cdnmain.sga360.co/static/ChatGPT_Image_27_oct_2025_10_28_59_2_u5cama.webp'/>,action:handleNavigate},
            {text:'Estadisticas Ordenes de Producción (OPS)',path:'analytics/OPS',icon:<img src='https://cdnmain.sga360.co/static/ChatGPT_Image_27_oct_2025_10_28_59_2_u5cama.webp'/>,action:handleNavigate},
            {text:'Estadisticas Documentos de Compra (DCS)',path:'analytics/DCS',icon:<img src='https://cdnmain.sga360.co/static/ChatGPT_Image_27_oct_2025_10_28_59_2_u5cama.webp'/>,action:handleNavigate},
            {text:'Estadisticas Facturas de Venta (FVS)',path:'analytics/FVS',icon:<img src='https://cdnmain.sga360.co/static/ChatGPT_Image_27_oct_2025_10_28_59_2_u5cama.webp'/>,action:handleNavigate},
            {text:'Estadisticas  Consumos de inventarios (CIS)',path:'analytics/CIS',icon:<img src='https://cdnmain.sga360.co/static/ChatGPT_Image_27_oct_2025_10_28_59_2_u5cama.webp'/>,action:handleNavigate},
        {text:'Calendario',path:'calendar',icon:<img src='https://cdnmain.sga360.co/static/LogoCalendario1_ig0avt.webp'/>,action:handleNavigate},
    ]
